...
function startConfettiInner() {
	...
	// Modern requestAnimationFrame for smooth animation
	...
	if (canvas === null) {
		...
		canvas.setAttribute("style", "position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 9999; pointer-events: none; display: block;");
	...
	// Initialize particles if not enough present
